...
app.post("/api/sendMail", function (req, res) {
    ...
    /*Setting up feedback mail options for sender*/
    ...
    /*Setting up mail options for feedback*/
    var mailOptions = {
        from: 'Upbeat support',
...
/*Schema to store artist objects*/
...
/*Schema to store playlist objects*/
...
/*Schema to store follower objects*/
var FollowerSchema = new mongoose.Schema({
    playlistId: String,
    followerUserId: String
}, { collection: "follower" });

/*Schema to score users*/
...
//Get playlists for multiple playlistIds
...
//Delete a doc from follower schema
...
//Get all playlists not for a user
...
app.put("/api/playlist",  function (req, res){
    PlaylistModel.update({ _id: req.body._id }, { $set: { tracks: req.body.tracks , publish: req.body.publish, name: req.body.name} }, function (err, doc) {
        PlaylistModel.find(function (err, data) {
            res.json(data);
        });
    });
